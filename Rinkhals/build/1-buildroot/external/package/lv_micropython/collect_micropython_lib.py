...
def main():
    ...
    # Needed because unix-ffi modules are not included by default in Manifestfile
    manifest.add_library("unix-ffi", os.path.join("$(MPY_LIB_DIR)", "unix-ffi"), prepend=True)
